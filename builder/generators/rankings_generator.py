...
renders /rankings/, for a given locale. This is sorting, not
calculating: the averages themselves come straight from profile.json,
...
def generate(athletes: list[dict], loc: dict, t: dict) -> None:
    ...
    html = template.render(
        ...
        t=t, locale=loc["code"], page_path="rankings/",
    )
    write_page(out_path(loc["prefix"], "rankings/index.html"), html)
