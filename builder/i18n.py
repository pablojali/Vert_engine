...
TRANSLATIONS = {
    "en": {
        ...
        "analysis_error_gpx_size": "The GPX file is too large (max 15 MB).",
    ...
    "es": {
        ...
        "analysis_error_gpx_size": "El archivo GPX es demasiado grande (máx. 15 MB).",
    ...
    "fr": {
        ...
        "analysis_error_gpx_size": "Le fichier GPX est trop volumineux (max. 15 Mo).",
