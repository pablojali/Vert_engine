...
TRANSLATIONS = {
    "en": {
        ...
        "home_stat_metrics_sub": "Proprietary indexes",
        "home_stat_circuits": "Race Series",
        "home_stat_circuits_sub": "Covered",
        "home_metrics_title": "The Metrics",
        "home_learn_more": "Learn more →",
        "home_vpi_desc": "Measures pure uphill climbing efficiency and power output.",
        "home_dmi_desc": "Evaluates downhill speed and technical descending skill.",
        "home_er_desc": "Quantifies pacing stability and endurance across the race.",
        "races_title": "Races",
    ...
    "es": {
        ...
        "home_stat_metrics_sub": "Índices propios",
        "home_stat_circuits": "Circuitos",
        "home_stat_circuits_sub": "Cubiertos",
        "home_metrics_title": "Las Métricas",
        "home_learn_more": "Ver más →",
        "home_vpi_desc": "Mide la eficiencia pura y la potencia en subida.",
        "home_dmi_desc": "Evalúa la velocidad y habilidad técnica en bajada.",
        "home_er_desc": "Cuantifica la estabilidad de ritmo y resistencia en carrera.",
    ...
    "fr": {
        ...
        "home_stat_metrics_sub": "Indices propriétaires",
        "home_stat_circuits": "Circuits",
        "home_stat_circuits_sub": "Couverts",
        "home_metrics_title": "Les Métriques",
        "home_learn_more": "En savoir plus →",
        "home_vpi_desc": "Mesure l'efficacité pure et la puissance en montée.",
        "home_dmi_desc": "Évalue la vitesse et la technicité en descente.",
        "home_er_desc": "Quantifie la stabilité du rythme et l'endurance en course.",
        "races_title": "Courses",
