...
# From the Turnstile widget created for vertlabs.run in the Cloudflare
# dashboard - see functions/README.md for the full setup.
env.globals["turnstile_site_key"] = "0x4AAAAAAEiAJIiuufqvPM_s"
